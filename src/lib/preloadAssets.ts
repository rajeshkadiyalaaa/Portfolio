...
const IMAGE_URLS = [
  ...
  staticAsset('/mountain-art.webp'),
  staticAsset('/mountain-right.webp'),
  staticAsset('/about-footer.webp'),
  staticAsset('/about-footer-1280.webp'),
  staticAsset('/projects-footer.webp'),
  staticAsset('/projects-footer-1280.webp'),
